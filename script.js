...
document.addEventListener('DOMContentLoaded',()=> fetchNews("India"));//load hote hain fetchNews wala function ko call kar dega
...
async function fetchNews (query){
    ...
    try {
        ...
        if (data.articles) {
            ...
            bindData([]); // Ensure bindData is called with an empty array if no articles are found
        }
    } catch (error) {
